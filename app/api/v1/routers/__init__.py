...
from app.api.v1.routers import health, users, auth, test, test2, log
...
api_router.include_router(log.router, prefix="/api/v1", dependencies=[Depends(current_active_user)])
